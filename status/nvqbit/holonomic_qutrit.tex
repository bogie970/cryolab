...
The key insight from Vitanov (2012)~\cite{Vitanov2012} is that any $\SU(3)$ transformation % Vitanov2012 Sec. II, Eq. (5)-(7): Givens decomposition theorem
...
transformation requires at most 9 parameters (matching $\dim[\SU(3)] = 8$ plus a global
phase)~\cite{Vitanov2012}.
...
The discrete Fourier transform on a qutrit requires 7 Givens steps or just 1 Householder
step. % Vitanov2012 Sec. IV, Example
